...
$query = "UPDATE project_monitoring set project_name='$project_name',client='$client',project_leader_name='$project_leader_name',project_leader_email='$project_leader_email',project_leader_image='$fileName',start_date='$start_date', end_date='$end_date', progress='$progress' WHERE id_project='$id_project'";
